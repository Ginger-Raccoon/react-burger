        ...
        <header className={cn("pl-10", "pr-10", "pt-10", "pb-10", "text", "text_type_main-default", s.header)}>
            <nav className={s.header__container}>
                <div className={s.nav__container}>
                    ...
                    <NavLink to='/order' className={cn(s.nav__element, 'pl-5', 'pr-5', 'pt-4', 'pb-4', 'mt-4', 'mb-4')} activeClassName={s.active}>
                        <ListIcon type={pathname === '/order' ? "primary" : "secondary"} />
                        <p className={cn("text", "text_type_main-default", "ml-2")}>Лента заказов</p>
                    </NavLink>
                </div>
                <Logo />
                <NavLink to='/account' className={cn(s.nav__element, 'pl-5', 'pr-5', 'pt-4', 'pb-4', 'mt-4', 'mb-4')} activeClassName={s.active}>
